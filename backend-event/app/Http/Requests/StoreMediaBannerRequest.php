...
class StoreMediaBannerRequest extends FormRequest
{
    /**
    ...
    {
        return true; // Cho phép tất cả người dùng tạo banner, có thể thêm logic xác thực sau
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'media_image_url' => 'required|url|max:255', // URL ảnh đã được upload trước đó
            'media_is_active' => 'required|boolean',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'media_image_url.required' => 'URL hình ảnh banner là bắt buộc.',
